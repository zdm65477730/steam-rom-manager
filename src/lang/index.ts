  ...
  return {
    parsers: {
      component: {
        docs__md: {
          ...
          steamCategories: [require(`${langPath}/steam-category.md`)],
    ...
    steamParser: {
      docs__md: {
        ...
        input: [require(`${langPath}/steam-parser-input.md`)],
      },
    },
    nonSRMShortcutsParser: {
      docs__md: {
        self: [require(`${langPath}/non-srm-shortcuts-parser.md`)],
        input: [] as string[],
      },
    },
    manualParser: {
    ...
    epicParser: {
      docs__md: {
        ...
        input: [require(`${langPath}/epic-parser-input.md`)],
      },
    },
    legendaryParser: {
      docs__md: {
        ...
        input: [require(`${langPath}/legendary-parser-input.md`)],
      },
    },
    UWPParser: {
      docs__md: {
        ...
        input: [require(`${langPath}/UWP-parser-input.md`)],
      },
    },
    battleNetParser: {
      docs__md: {
        ...
        input: [require(`${langPath}/battle-net-parser-input.md`)],
      },
    },
    uplayParser: {
      docs__md: {
        ...
        input: [require(`${langPath}/uplay-parser-input.md`)],
      },
    },
    gogParser: {
      docs__md: {
        ...
        input: [require(`${langPath}/gog-parser-input.md`)],
      },
    },
    amazonGamesParser: {
      docs__md: {
        ...
        input: [require(`${langPath}/amazon-games-parser-input.md`)],
      },
    },
    itchIoParser: {
      docs__md: {
        ...
        input: [require(`${langPath}/itch-io-parser-input.md`)],
      },
    },
    globParser: {
      docs__md: {
    ...
    eaDesktopParser: {
      docs__md: {
        ...
        input: [require(`${langPath}/ea-desktop-parser-input.md`)],
      },
    },
    sgdbProvider: {
      docs__md: {
